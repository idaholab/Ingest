defmodule IngestWeb.LiveComponents.RequestModal do
  @moduledoc """
  ...
  def render(assigns) do
    ...
    <div>
      <div class="mt-6">
        <button
          type="button"
          phx-click={show_modal("request_modal")}
  ...
  @impl true
  def mount(socket) do
    {:ok, socket |> assign(:request_form, %Request{} |> Ecto.Changeset.change() |> to_form())}
  end
end
