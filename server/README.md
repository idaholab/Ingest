...
4. Run `mix ecto.setup` - this will run all the required migrations to setup your database.
5. Run `mix phx.gen.secret` and copy the output to line 27 in your `config/dev.exs` file - under `secret_key_base`
